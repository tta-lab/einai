...
If the page doesn't contain the answer, use `$ web search` to find related pages or check official docs.
...
- Always use `$ web fetch` — never try to infer content you haven't fetched
